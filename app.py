...
def render_calls_page():
    ...
    if sel:
        ...
        with c2:
            if st.button(
                "🔬 Değerlendirmeye Git", type="primary",
                use_container_width=True,
            ):
                st.rerun()
...
""")
    ...
    with d1:
        st.download_button(
            ...
            f"gm_{fn}.json", "application/json",
            use_container_width=True,
        )
    with d2:
        st.download_button(
            "📋 ESR",
            generate_esr_report(results, ed),
            f"gm_{fn}_esr.md", "text/markdown",
            use_container_width=True,
        )
    with d3:
        st.download_button(
            ...
            f"gm_{fn}_coach.md", "text/markdown",
            use_container_width=True,
        )
